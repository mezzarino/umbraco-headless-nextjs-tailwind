...
export default function Artist({
  ...
  return (
    <>
      ...
      <div data-theme={`${title}`.toLowerCase()} className={`mx-auto flex p-6 bg-gray-100 mt-10 rounded-lg shadow-xl`}>
      <div className="ml-6 pt-1">
          <h1 className="text-2xl text-primary leading-tight font-title">{title}</h1>
          <div
